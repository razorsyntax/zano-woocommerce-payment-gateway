<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    <tr>
        <td>Exchange rate</td>
        <td>1 ZANO = <?php echo $details['rate_formatted'].' '.$details['currency']; ?></td>
    </tr>
    <tr>
        <td>Total amount</td>
        <td><?php echo $details['amount_total_formatted']; ?> ZANO</td>
    </tr>
    <tr>
        <td>Total paid</td>
        <td><?php echo $details['amount_paid_formatted']; ?> ZANO</td>
    </tr>
    <tr>
        <td>Total due</td>
        <td><?php echo $details['amount_due_formatted']; ?> ZANO</td>
    </tr>
    <tr>
        <td>Order age</td>
        <td><?php echo Zano_Gateway::format_seconds_to_time($details['order_age']) ?> ago</td>
    </tr>
    <tr>
...
<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    ...
    <tr>
        <td>
            <a href="<?php echo ZANO_GATEWAY_EXPLORER_URL.'transaction/'.$tx['txid']; ?>" target="_blank"><?php echo $tx['txid']; ?></a>
        </td>
        <td><?php echo $tx['height']; ?></td>
        <td><?php echo sprintf(ZANO_GATEWAY_ATOMIC_UNITS_SPRINTF, $tx['amount'] / ZANO_GATEWAY_ATOMIC_UNITS_POW); ?> ZANO</td>
    </tr>
    <?php endforeach; ?>
</table>
<?php endif; ?>
