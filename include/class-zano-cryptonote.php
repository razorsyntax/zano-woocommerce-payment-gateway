<?php
/*
 * Original Copyright (c) 2018 Monero-Integrations
 * Updated for Zano by razorsyntax
*/
...
require_once('class-zano-base58.php');

class Zano_Cryptonote
{
    protected $ed25519;
    public function __construct()
    {
        $this->ed25519 = new ed25519();
        $this->base58 = new Zano_base58();
        $this->address_prefix = ZANO_GATEWAY_ADDRESS_PREFIX;
        $this->address_prefix_integrated = ZANO_GATEWAY_ADDRESS_PREFIX_INTEGRATED;
    }
